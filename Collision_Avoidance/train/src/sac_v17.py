...
class SAC(object):
    def __init__(self, act_dim, obs_dim, lr_actor, lr_value, gamma, tau, buffers, alpha=0.2, name=None, seed=1):
        ...
        self.writer = tf.summary.FileWriter('/home/chi/SAC_0421/src/Collision_Avoidance/train/logs/'+NAME+'/'+self.name+'/', self.sess.graph)
        self.saver = tf.train.Saver()
        self.path = '/home/chi/SAC_0421/src/Collision_Avoidance/train/weights/'+ NAME +'/'+ self.name
